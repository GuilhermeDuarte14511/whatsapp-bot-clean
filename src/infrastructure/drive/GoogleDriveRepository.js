...
exports.GoogleDriveColaboradorRepository = void 0;
...
const CREDENTIALS_PATH = path_1.default.resolve('tokens/client_secret_394353011841-85om534p3do7280ganbp6436noji0ghb.apps.googleusercontent.com.json');
...
class GoogleDriveColaboradorRepository {
    constructor(drive) {
    ...
    getOrCreateFolder(folderName, parentId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((_a = existing.data.files) === null || _a === void 0 ? void 0 : _a.length) {
...
exports.GoogleDriveColaboradorRepository = GoogleDriveColaboradorRepository;
